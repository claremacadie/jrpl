...
// JrplRoute.php is specific code for accessing the jrpl database
// These files are called by including autoload.php
// autoload.php loads class files when a class is used for the first time
// Beware, an extra file not in the book is required to get everything working
...
//try {
	...
	// (Similarly, IjdbRoutes is in the Jrpl namespace)
